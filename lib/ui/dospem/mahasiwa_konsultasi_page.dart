...
class MahasiswaKonsultasi extends StatefulWidget {
  const MahasiswaKonsultasi({super.key});

  @override
  State<MahasiswaKonsultasi> createState() => _MahasiswaKonsultasiState();
}

class _MahasiswaKonsultasiState extends State<MahasiswaKonsultasi> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Mahasiswa Konsultasi yang Telah dipilih dosennya',
        ),
